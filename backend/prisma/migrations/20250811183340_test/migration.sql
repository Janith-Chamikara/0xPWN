...
INSERT INTO "new_Challenge" ("category_id", "challenge_id", "created_at", "created_by", "description", "difficulty", "flag", "points", "resources", "title") SELECT "category_id", "challenge_id", "created_at", "created_by", "description", "difficulty", "flag", "points", "resources", "title" FROM "Challenge";
